## kinematics_interface (jazzy) - 1.7.1-1

The packages in the `kinematics_interface` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release kinematics_interface -r jazzy -y` on `Thu, 14 May 2026 08:46:14 -0000`
...
## kinematics_interface (kilted) - 2.4.2-1

The packages in the `kinematics_interface` repository were released into the `kilted` distro by running `/usr/bin/bloom-release kinematics_interface -r kilted -y` on `Thu, 14 May 2026 08:44:27 -0000`
...
## kinematics_interface (lyrical) - 2.4.2-1

The packages in the `kinematics_interface` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release kinematics_interface -r lyrical -y` on `Thu, 14 May 2026 08:41:54 -0000`
...
## kinematics_interface (rolling) - 2.4.2-1

The packages in the `kinematics_interface` repository were released into the `rolling` distro by running `/usr/bin/bloom-release kinematics_interface -r rolling -y` on `Thu, 14 May 2026 08:40:35 -0000`
...
## kinematics_interface (humble) - 0.4.2-1

The packages in the `kinematics_interface` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble kinematics_interface` on `Thu, 02 Apr 2026 12:43:31 -0000`
...
## kinematics_interface (jazzy) - 1.7.0-1

The packages in the `kinematics_interface` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy kinematics_interface` on `Sun, 07 Dec 2025 19:57:24 -0000`
...
## kinematics_interface (kilted) - 2.4.0-1

The packages in the `kinematics_interface` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted kinematics_interface` on `Sun, 07 Dec 2025 19:30:50 -0000`
...
## kinematics_interface (rolling) - 2.4.0-2

The packages in the `kinematics_interface` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling kinematics_interface` on `Sun, 07 Dec 2025 19:23:19 -0000`
...
## kinematics_interface (rolling) - 2.4.0-1

The packages in the `kinematics_interface` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling kinematics_interface` on `Sat, 06 Dec 2025 22:36:52 -0000`
...
## kinematics_interface (humble) - 0.4.1-1

The packages in the `kinematics_interface` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble kinematics_interface` on `Thu, 02 Oct 2025 09:06:43 -0000`
...
## kinematics_interface (jazzy) - 1.6.0-1
...
The packages in the `kinematics_interface` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling kinematics_interface` on `Thu, 02 Oct 2025 08:56:17 -0000`
...
The packages in the `kinematics_interface` repository were released into the `jazzy` distro by running `/home/bmagyar/.local/bin/bloom-release --rosdistro jazzy kinematics_interface` on `Mon, 11 Nov 2024 12:14:53 -0000`
